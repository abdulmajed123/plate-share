    ...
    <div>
      <section className="py-20 bg-white dark:bg-black">
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-4 text-center">
          {/* Stat 1 */}
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 flex flex-col items-center border border-gray-100 dark:border-gray-900 transition-transform transform hover:scale-105 hover:shadow-2xl duration-300">
