        ...
        <div className="p-5 flex-1 flex flex-col justify-between">
          ...
          <div className="flex justify-center mt-auto">
            <Link
              ...
              className="btn bg-linear-to-r from-pink-500 to-red-500 hover:from-red-600 hover:to-pink-500 px-6 py-2 w-full text-white   rounded-xl font-medium shadow-sm  transition-all duration-300 text-center border-0"
            >
              View Details
            </Link>
          </div>
