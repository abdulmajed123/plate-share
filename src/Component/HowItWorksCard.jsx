...
const HowItWorksCard = () => {
  return (
    <div>
      <section className="py-20 bg-gray-50 dark:bg-black  animate-fade-in">
        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-8 px-4">
          {/* Step 1 */}
          <div className="bg-white dark:bg-slate-800  rounded-2xl shadow-lg p-8 text-center flex-1 transform hover:scale-105 transition-transform">
